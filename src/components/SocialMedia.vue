<template>
    <div class="flex flex-row text-white text-left text-2xl mt-8 lg:mt-[1.5em] gap-2">
        ...
        <a href="https://www.linkedin.com/in/bintang-nugraha-putra-037a2b319?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" class="text-white hover:text-teal-400 focus:text-teal-800 transition-all duration-300 ease-in-out"><i class='bx bxl-linkedin'></i></a>
        <a href="https://wa.me/6283899161015" target="_blank" class="text-white hover:text-teal-400 focus:text-teal-800 transition-all duration-300 ease-in-out"><i class='bx bxl-whatsapp'></i></a>
    </div>
</template>